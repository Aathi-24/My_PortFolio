            ...
            >
              <div className="grid sm:grid-cols-2 gap-6">
                <div>
                  ...
                  <motion.input
                    ...
                    className="w-full px-4 py-3 bg-muted/50 border border-border rounded-xl text-foreground placeholder:text-muted-foreground focus:outline-none focus:border-primary/50 focus:ring-2 focus:ring-primary/20 transition-all"
              ...
              <div>
                ...
                <motion.textarea
                  ...
                  className="w-full px-4 py-3 bg-muted/50 border border-border rounded-xl text-foreground placeholder:text-muted-foreground focus:outline-none focus:border-primary/50 focus:ring-2 focus:ring-primary/20 transition-all resize-none"
              ...
              <motion.button
                ...
                whileHover={{ scale: 1.02, boxShadow: "0 0 30px hsl(186 100% 50% / 0.4)" }}
                whileTap={{ scale: 0.98 }}
              ...
              <div className="flex flex-wrap gap-4">
                {socialLinks.map((item, index) => (
                  <motion.a
                    ...
                    whileTap={{ scale: 0.9 }}
                    className="p-4 rounded-xl bg-muted/50 hover:bg-primary/10 hover:border-primary/50 border border-border/50 hover:shadow-[0_0_20px_hsl(186_100%_50%/0.3)] transition-all"
