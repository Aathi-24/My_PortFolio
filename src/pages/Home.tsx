      ...
      <div className="relative z-10 container-custom px-4 pt-24">
        <div className="text-center max-w-4xl mx-auto">
          ...
          >
            <Link to="/projects">
              <motion.button
                whileHover={{ scale: 1.05, boxShadow: "0 0 30px hsl(186 100% 50% / 0.4)" }}
                whileTap={{ scale: 0.95 }}
          ...
          >
            {[
              ...
              <motion.a
                ...
                whileTap={{ scale: 0.9 }}
                className="p-3 glass rounded-xl hover:border-primary/50 hover:shadow-[0_0_20px_hsl(186_100%_50%/0.3)] transition-all duration-300"
                aria-label={label}
              >
